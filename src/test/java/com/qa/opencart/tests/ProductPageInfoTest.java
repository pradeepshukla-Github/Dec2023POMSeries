...
//***********************************************
	@DataProvider
	public Object [][] getProductSearchData1()
	{
		return new Object [][] {
			{"macbook", "macbook pro"},
			{"imac","imac"},
			{"Sumsung","samsung galaxy tab"}
		};
	}
	
	@Test(dataProvider="getProductSearchData1")
	public void productHeaderTest1(String searchkey, String productName)
	{
